...
<header>
	...
	<div style=" padding-left: 15%; padding-right: 15%;">
		<form method="post">
		<div>
			<h2 class="hc">등록할 게시물을 입력하세요</h2>
		</div>
		<div class="m11">
			<label class="lab11">제목 :</label>
			<input type="text" maxlength="40" class="min"> 
		</div>

		<div class="m13">
			<label class="lab12">내용 :</label>
			<textarea id="summernote" rows="20" cols="80"></textarea>
		</div>
	...
	<div class="b11">
    	<a href="add"><button class="b12">등록</button></a>
    </div>
    
    <div class="b11">
    	<a href="add"><button class="b12">등록 취소</button></a>
    </div>
