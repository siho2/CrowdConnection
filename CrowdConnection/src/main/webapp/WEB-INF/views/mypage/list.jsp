...
<body>
	...
	<table id="list" class="table table-hover">
		<thead>
			...
			<tbody>
			<tr>
			<td class="content">CHAT GPT로 수익올리기</td>
			<td class="price">500원</td>
			<td class="date">23.05.16</td>
			</tr>
			<tr>
			<td class="content">블로그 운영 비법</td>
			<td class="price">300원</td>
			<td class="date">23.05.14</td>
			</tr>
			<tr>
			<td class="content">면역력 증가 알약</td>
			<td class="price">100원</td>
			<td class="date">23.05.11</td>
			</tr>
		</tbody>
	</table>
	</div>
